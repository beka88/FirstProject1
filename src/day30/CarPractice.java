...
public class CarPractice {
    public static void main(String[] args) {
        String[]cars = {"Acura-NSX", "Chevrolet-Corvette", "Chevrolet-Cavalier",
                ...
                "Honda-Odyssey",
                "Chrysler-Crossfire", "Lexus-RX Hybrid",
                "BMW-M6", "Mitsubishi-Challenger", "Subaru-Forester",
                "Acura-TSX",
                "Lexus-GS",
                "Bentley-Continental GTC",
                "Lincoln-Town Car",
        ...
        for (int i = 0; i <cars.length ; i++) {
            if(cars[i].equalsIgnoreCase("Chevrolet-camaro")){
